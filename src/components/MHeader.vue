    ...
    <div class="nav">
      <ul class="navbar">
        <el-menu  class="el-menu-demo" mode="horizontal" text-color="black" active-text-color="#409eff">
          ...
          <el-menu-item index="2" @click="goto('/online')">在线指导</el-menu-item>
          <el-menu-item index="3" @click="goto('/newsList')">农产品新闻</el-menu-item>
          <el-menu-item index="4" @click="goto('/cultivation')">培育技术</el-menu-item>
          <el-menu-item index="5" @click="goto('/queryFertilizer')">用肥用药</el-menu-item>
          <el-menu-item index="6" @click="goto('/traceability')">溯源系统</el-menu-item>
          <el-menu-item index="7" @click="goto('/categoryDetails')">市场中心</el-menu-item>
          <el-menu-item index="8">
            <el-input placeholder="请输入内容" v-model="input" class="input-with-select" size="small">
              <el-select v-model="select" slot="prepend" placeholder="请选择" style="width:90px">
                <el-option label="农场品新闻" value="1"></el-option>
                <el-option label="培育技术" value="2"></el-option>
                <el-option label="用肥用药查询" value="3"></el-option>
              </el-select>
